...
<li <?php post_class( 'listing__room' ); ?>>
	...
	<?php if ( $room->is_variable_room() ) : ?>
		...
		<a href="#room-variations-<?php echo absint( $room->id ); ?>" data-closed="<?php esc_html_e( 'Show rates', 'wp-hotelier' ); ?>" data-open="<?php esc_html_e( 'Hide rates', 'wp-hotelier' ); ?>" class="calluna-button btn btn-primary small button--toggle-rates"><?php esc_html_e( 'Hide rates', 'wp-hotelier' ); ?></a>
