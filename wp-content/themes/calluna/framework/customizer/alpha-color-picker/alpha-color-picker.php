...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			CALLUNA_THEME_URI . 'framework/customizer/alpha-color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			CALLUNA_THEME_URI . 'framework/customizer/alpha-color-picker/alpha-color-picker.css',
