...
class Calluna_Sanitize_Data {

    /**
     * Parses data
     *
     */
    public function calluna_parse_data( $data, $type ) {
...
// Helper function runs the Calluna_Sanitize_Data class
function calluna_sanitize_data( $data = '', $type = '' ) {
    if ( $data && $type ) {
        $class = new Calluna_Sanitize_Data();
        return $class->calluna_parse_data( $data, $type );
    }
}