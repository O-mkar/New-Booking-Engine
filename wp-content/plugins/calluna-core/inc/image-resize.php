...
// Start Class
if ( ! class_exists( 'Calluna_Core_Image_Resize' ) ) {

    class Calluna_Core_Image_Resize {
        ...
        public function __construct() {
            $this->calluna_core_retina_enabled = get_theme_mod( 'calluna_core_retina', false );
            $this->calluna_core_retina_enabled = apply_filters( 'calluna_core_image_resize_retina', $this->calluna_core_retina_enabled );
        }
         ...
         */
        public function calluna_core_process( $args ) {


            // Args must be an array
            if ( ! is_array( $args ) ) {
                print_r( esc_html__('Fatal Error: Image resize args are not an array, you must update your template files.','calluna-shortcodes') );
                return false;
            }
            ...
            if ( $crop && get_theme_mod( 'calluna_core_image_resizing', true ) ) {
                if ( is_array( $crop ) ) {
...
// Helper function for resizing images using the Calluna_Ext_Image_Resize class
if ( ! function_exists( 'calluna_core_image_resize' ) ) {
    function calluna_core_image_resize( $args ) {
        $class = new Calluna_Core_Image_Resize;
