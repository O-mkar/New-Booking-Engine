...
if ( ! class_exists( 'WP_Importer_Logger' ) ) {
	require CALLUNA_CORE_PATH . 'calluna-demo-importer/vendor/humanmade/WordPress-Importer/class-logger.php';
}
if ( ! class_exists( 'WP_Importer_Logger_CLI' ) ) {
	require CALLUNA_CORE_PATH . 'calluna-demo-importer/vendor/humanmade/WordPress-Importer/class-logger-cli.php';
}
