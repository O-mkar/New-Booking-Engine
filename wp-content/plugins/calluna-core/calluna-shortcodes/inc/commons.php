...
function calluna_core_shortcodes_font_icon_class( $icon = null ) {
	if ( ! $icon ) {
		return;
	}
...
function calluna_core_shortcodes_button_sizes_array() {
	...
	return apply_filters( 'calluna_core_shortcodes_button_sizes_array', $button_sizes );
}

// Order By
function calluna_core_shortcodes_order_by_array() {
	$order_by = array(
	...
	return apply_filters( 'calluna_core_shortcodes_order_by_array', $order_by );
}

// Order By for Services
function calluna_core_shortcodes_rooms_order_by_array() {
	$room_order_by = array(
		 esc_html__( 'Date', 'calluna-shortcodes' )           => 'date',
		 esc_html__( 'Name', 'calluna-shortcodes' )          	=> 'name',
		 esc_html__( 'IDs', 'calluna-shortcodes' )         	=> 'ids',
		 esc_html__( 'Menu Order', 'calluna-shortcodes' )     => 'menu_order'
		 
	);
	return apply_filters( 'calluna_core_shortcodes_rooms_order_by_array', $room_order_by );
}

// Post Types
function calluna_core_shortcodes_get_post_types() {
	$array = array();
...
// Taxonomies
function calluna_core_shortcodes_get_taxonomies() {
	$array = array();
